...
export const UI = {
  ...
  zh: {
    ...
    'edu.section': '第二版',
    'edu.title': '教育背景',
    'edu.description': '深圳大学，MIT、斯坦福与 CMU 的公开课程，以及支撑这些工程判断的理论基础。',
    'edu.standfirst':
    ...
    'edu.fundamentalsStandfirst':
      '课本上的知识，只有当它能解释你在生产环境里见过的现象时才真正算数。下面这些是确实反复用得上的部分。',
    'edu.cta': '看这些理论落在哪里',

    'stack.section': '第三版',
    'stack.title': '技术栈',
    'stack.description': '我在生产环境里使用的工具，以及我对每一件的真实看法。',
    'stack.standfirst':
      '下面每一项都跑在我的生产环境里。点开任意一项，它会展开成一篇短文：这件工具解决什么问题、代价在哪，以及它在哪里坑过我。',
    'stack.entries': '项',
    'stack.close': '关闭',
    'stack.learned': '关键认识',
